import 'package:chart_harakia/screens/admin_services/payment_receivegetlist.dart';
import 'package:chart_harakia/screens/bottom_nav_1_Administrator/screens_admin/payment_recieveDetails.dart';
...
class PaymentRecieveScreen extends StatefulWidget {
  const PaymentRecieveScreen({super.key});

  @override
  State<PaymentRecieveScreen> createState() => _PaymentRecieveScreenState();
}
...
class _PaymentRecieveScreenState extends State<PaymentRecieveScreen> {
  ...
  void initState() {
    super.initState();
    paymentDataFuture = PaymentRecieveGet().fetchpaymentrecievegetservice();
    _fetchPayments();
  }
      ...
      child: GestureDetector(
        onTap: () async {
          ...
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => PaymentRecievedetails(paymentItem: item),
            ),
          );
 ...
 Widget _buildStatusFilter() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("استلام المدفوعات", textDirection: TextDirection.rtl),
