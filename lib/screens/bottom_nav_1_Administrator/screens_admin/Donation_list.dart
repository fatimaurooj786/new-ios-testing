import 'package:chart_harakia/screens/admin_services/donation_getlist.dart';

import 'package:chart_harakia/screens/bottom_nav_1_Administrator/screens_admin/donationdetailslist.dart';
...
class _DonationListState extends State<DonationList> {
  ...
  void initState() {
    super.initState();
    paymentDataFuture = DonationGetlist().fetchdonationGetservice();
    _fetchPayments();
  }
  ...
  void _applyFilter(String query) {
    setState(() {
      filteredPaymentData = allPaymentData.where((payment) {
        ...
        final paymentDate = DateTime.tryParse(payment['date']);
      ...
      child: GestureDetector(
        onTap: () async {
          ...
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => Donationdetailslist(paymentItem: item),
            ),
          );
