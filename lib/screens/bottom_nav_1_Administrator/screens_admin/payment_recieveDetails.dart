...
class PaymentRecievedetails extends StatefulWidget {
  final dynamic paymentItem;

  const PaymentRecievedetails({super.key, required this.paymentItem});

  @override
  _PaymentRecievedetailsState createState() => _PaymentRecievedetailsState();
}

class _PaymentRecievedetailsState extends State<PaymentRecievedetails>
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      textDirection: TextDirection.rtl, // Set the global RTL layout
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: Directionality( // Override the back button to be LTR
            textDirection: TextDirection.ltr, // Forces LTR for the back icon
            child: IconButton(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildDetailWithIcon("الحساب المدفوع إليه", widget.paymentItem['account_paid_to'], labelStyle, valueStyle, Icons.account_balance_wallet, Colors.cyan),
                          ...
                          child: Column(
                            ...
                            children: [
                              for (var account in accounts) ...[
                                ...
                                buildDetailWithIcon("مركز التكلفة الداخلي", account['in_house_cost_center'], labelStyle, valueStyle, Icons.account_tree, Colors.purple),
                                buildDetailWithIcon("المبلغ", account['amount'], labelStyle, valueStyle, Icons.attach_money, Colors.green),
                                buildDetailWithIcon("رمز الملف", account['file'], labelStyle, valueStyle, Icons.insert_drive_file, Colors.blue),
  ...
  Widget buildDetailWithIcon(String label, dynamic value, TextStyle labelStyle,
      TextStyle valueStyle, IconData icon, Color iconColor) {
