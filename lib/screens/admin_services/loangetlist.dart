...
class Loangetlist {
  final String loan_get= 'https://demoharakia.charterp.org/api/method/loan_application';

  // Helper function to make GET requests
  Future<List<dynamic>?> fetchloangetservice() async {
    ...
    if (cookies != null) {
      try {
        ...
        if (response.statusCode == 200) {
          ...
          print('Failed to fetch beneficiaries data from $loan_get.');
          return null;
        }
      } catch (e) {
