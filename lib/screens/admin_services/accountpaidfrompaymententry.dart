...
class accountpaidfromServiceGet {
  final String accountpaidfrompayment = 'https://harakia.charterp.org/api/method/All_accounts';

  // Helper function to make GET requests
  Future<List<dynamic>?> fetchaccountpaidfromservice() async {
