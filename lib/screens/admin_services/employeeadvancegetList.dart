...
class Employeeadvancegetlist {
  final String Payment_recieve_get= 'https://demoharakia.charterp.org/api/method/employee_advance';

  // Helper function to make GET requests
  Future<List<dynamic>?> fetchEmployeeGetservice() async {
