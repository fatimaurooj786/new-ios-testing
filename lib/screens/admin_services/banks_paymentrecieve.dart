...
class BanksbankPaymentrecieve {
  final String mode_of_payment = 'https://harakia.charterp.org/api/method/a_bank';

  // Helper function to make GET requests
  Future<List<dynamic>?> fetchbankpaymentservice() async {
