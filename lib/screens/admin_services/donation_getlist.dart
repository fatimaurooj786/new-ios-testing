...
class DonationGetlist {
  final String Payment_recieve_get= 'https://harakia.charterp.org/api/method/donation_list';

  // Helper function to make GET requests
  Future<List<dynamic>?> fetchdonationGetservice() async {
