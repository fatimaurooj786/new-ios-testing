...
class modeofpaymentServiceGet {
  final String mode_of_payment = 'https://harakia.charterp.org/api/resource/Mode of Payment';

  // Helper function to make GET requests
  Future<List<dynamic>?> fetchmodeofpaymentservice() async {
