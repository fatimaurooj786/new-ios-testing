...
class CustomDatePickertablemanadatory extends StatefulWidget {
  final String labelText;
  final DateTime? selectedDate;
  final Function(DateTime?) onDateChanged;

  const CustomDatePickertablemanadatory({
    Key? key,
...
class _CustomDatePickerState extends State<CustomDatePickertablemanadatory> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      width: MediaQuery.of(context).size.width * 0.5, // Set 50% width
      child: Column(
